package travelcompany.common.business.database.datasource;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import travelcompany.common.business.exception.ConnectionAchieveException;
...
public class HikariCpDataSource implements ConnectionProvider {
    ...
    public Connection getConnection() {
        try {
            ...
            throw new ConnectionAchieveException(e);
        }
    }
